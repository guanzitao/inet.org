    ...
    navbar:[
      ...
      },
      {
        ...
        children: [
          {
            text:'人脸识别签到打卡系统',
            link:'http://1.12.74.98/camera/'
          },
          {
            text:'二手房价分析系统',
            link:'https://2e19q21138.yicp.fun/'
          },
          {
            text:'高德租房系统',
            link:'http://1.12.74.98/gaode/'
          },
          {
            text:'豆瓣电影分析系统',
            link:'http://1.12.74.98/douban'
          },
          {
            text:'上课考勤签到程序',
            link:'http://47.115.205.14/#/pages/index/index'
          },
          // {
          //   text:'签到',
          //   link:'/features/sign/'
